...
function UserSignup() {
  ...
  return (
    ...
    <input id="dob" type='date' className='form-control' {...register("dob",{required:{
                    value:true,
    ...
    <select id="gender" style={{width:"300px", textAlign:"center"}} {...register("gender",{required:{
                    value:true,
                    message:"This Field is required"
                }
                })}>
    ...
    <input id="email" type='email' className='form-control' {...register("email",{required:{
                    value:true,
                    message:"This Field is required"
                },
                pattern:{
    ...
    <input id='mocile' type='text'  className='form-control' {...register("mobile",
                ...
                minLength:{
                  value:13,
                  message:"Mobile No can not less than +91 and 10 digits"
                },
                maxLength:{
                  value:13,
                  message:"Mobile no can not greater than +91 and 10 digits"
                },
    ...
    <input id='signature' type='file' accept="image/png, image/jpeg" className='form-control' {...register("signature",{required:{
                    value:true,
                    message:"This Field is required"
                }
                })}/>
    ...
    <select id="role" style={{width:"300px", textAlign:"center"}} {...register("role",{required:{
                    value:true,
                    message:"This Field is required"
                }
                })}>
    ...
    <input id='username' type='text' className='form-control' {...register("username",{required:{
                    value:true,
                    message:"This Field is required"
                },
                minLength:{
