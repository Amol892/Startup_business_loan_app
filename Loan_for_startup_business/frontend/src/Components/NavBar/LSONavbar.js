         ...
         <div className="container-fluid">
            <img src={grow} alt='not found' width={120} height={100}></img>
             ...
             <div className="navbar-nav">
                 ...
                 <NavLink style={{marginLeft:80,borderRadius:10,padding:10,color:'white'}} className="nav-link active" to="/lsoDashboard"><b>Dashboard</b></NavLink>
                
                 <NavLink style={{marginLeft:700,borderRadius:10,padding:10,color:'white'}} className="nav-link active" to="#"><b>LSOProfile</b></NavLink>
