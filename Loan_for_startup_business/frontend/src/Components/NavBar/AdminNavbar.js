         ...
         <div className="container-fluid">
            <img src={grow} alt='not found' width={230} height={100}></img>
             ...
             <div className="navbar-nav">
                 <NavLink style={{marginLeft:110,borderRadius:10,padding:10,color:'white'}} className="nav-link active" aria-current="page" to="/"><b>Home</b></NavLink>
                 ...
                 <NavLink style={{marginLeft:150,borderRadius:10,padding:10,color:'white'}} className="nav-link active" to="#"><b>AdminProfile</b></NavLink>
