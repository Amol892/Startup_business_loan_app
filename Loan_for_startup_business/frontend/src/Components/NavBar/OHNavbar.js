         ...
         <div className="container-fluid">
            <img src={grow} alt='not found' width={120} height={100}></img>
             ...
             <div className="navbar-nav">
                 ...
                 <NavLink style={{marginLeft:80}} className="nav-link active" to="/ohDashboard"><b>Dashboard</b></NavLink>
                
                 <NavLink style={{marginLeft:700}} className="nav-link active" to="#"><b>OHProfile</b></NavLink>
